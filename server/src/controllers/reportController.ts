...
class ReportController {
    ...
    public static async create(timestamp: number, UserId: string, { name, location, imageUrl, PetId, reportNumber }: {
        name: string,
        reportNumber: number,
        imageUrl: string,
        location: string,
    ...
    public static async edit(UserId: string, idReport: string, { name, location, imageUrl }:
        {
            name?: string,
            location?: string,
            imageUrl?: string
